                ...
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="register-card">
                        <div class="card-header">
                            ...
                            <p>Join the VidOcean community today</p>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-4 form-check">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        I agree to the <a href="#" class="ocean-link">Terms of Service</a> and 
                                        <a href="#" class="ocean-link">Privacy Policy</a>
                                    </label>
                                </div>
                                ...
                                <button type="submit" class="btn btn-ocean w-100 mb-3">Create Account</button>
                                
                                <div class="text-center">
                                    <p class="mb-0 text-ocean">
                                        Already have an account? 
                                        <a href="{{ route('login') }}" class="ocean-link">Sign In</a>
                                    </p>
                                </div>
                            </form>
                        </div>
